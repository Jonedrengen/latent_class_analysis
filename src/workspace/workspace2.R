...
dat <- read.csv("/Users/B328695/Desktop/NETHMAP/blcm_analysis.csv", check.names = FALSE, stringsAsFactors = FALSE)

hist <- generate_hist(dat, title = "Predicted Food-Animal Origin Histogram")
ggsave(file="NETHMAP_animal.svg", plot=hist, width=18, height=14)
